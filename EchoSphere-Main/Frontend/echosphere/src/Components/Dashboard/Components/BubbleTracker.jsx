...
const FlipkartBubbleTracker = ({ bubbles, variableValue, gid, date, dept, summary }) => {
    ...
    return bubbles.map((bubble, index) => {
      ...
      return (
        <>
          <div
            key={bubble.id}
            className={`flipkart-bubble${isCompleted ? ' completed' : ''} mt-2`}
            style={{
...
export default FlipkartBubbleTracker;
